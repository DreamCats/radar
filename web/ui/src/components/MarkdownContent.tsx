...
function renderInlineMarkdown(text: string): ReactNode[] {
  ...
  while ((match = pattern.exec(text)) !== null) {
    ...
    if (token.startsWith("**")) {
      ...
      const className = percentClassName(strongText.trim(), "markdown-percent-up", "markdown-percent-down");
      nodes.push(
      ...
      nodes.push(
        <span className={percentClassName(percentText, "markdown-percent-up", "markdown-percent-down")} key={match.index}>
          {percentText}
        </span>,
      );
