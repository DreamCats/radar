...
const SUGGESTED_QUESTIONS = [
  ...
  { label: "今日盘中指数", prompt: "查一下今日盘中主要指数：上证指数、沪深300、创业板指。用实时行情工具拿最新点位、涨跌幅、成交额和时间戳，最后用 3 句话说明市场状态。" },
  { label: "策略线索", prompt: "从当前策略信号里筛出 3 只适合继续跟踪的股票，按证据强度排序，说明所属线索、为什么值得研究、需要验证什么、哪些风险条件下暂缓跟踪。" },
